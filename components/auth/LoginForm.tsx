    ...
    <Card className="border-lagoon/25 p-6 shadow-sm shadow-lagoon/10 sm:p-8">
      <div className="space-y-6">
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-full border border-stone-200 bg-white py-3 text-sm font-semibold text-stone-800 shadow-sm transition hover:bg-stone-50 disabled:opacity-60"
        >
        ...
        <div>
          ...
          <label className="mt-2 flex cursor-pointer items-center gap-2 text-sm text-stone-700">
            <input
              ...
              className="rounded border-stone-300 text-forest"
            />
            Show password
          </label>
        </div>
